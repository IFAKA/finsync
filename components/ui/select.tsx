...
/**
 * SelectTrigger following Vercel design guidelines:
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      // Base styles
      "flex h-10 w-full items-center justify-between rounded-md border border-border bg-background px-3 py-2",
      // Typography - 16px on mobile
